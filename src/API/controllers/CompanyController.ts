  ...
  async show(req: Request, res: Response): Promise<Response> {
    try{
      ...
      const item = {
        ...
        productCardTypeMobile: company.productCardTypeMobile || "grid",
        productCardTypeDesktop: company.productCardTypeDesktop || "right_square",
        productActionMode: company.productActionMode || "checkout",
